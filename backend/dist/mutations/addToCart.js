...
async function addToCart(root, // unused variable - we don't need it here but it's required by the resolver signature in Keystone 5 (it's not required in Keystone 6)
{ productId }, context) {
