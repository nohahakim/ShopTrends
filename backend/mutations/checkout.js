            ...
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, context.lists.User.findOne({
                            where: { id: userId },
                            resolveFields: graphql(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n      id\n      name\n      email\n      cart {\n        id\n        quantity\n        product {\n          name\n          price\n          description\n          id\n          photo {\n            id\n            image {\n              id\n              publicUrlTransformed\n            }\n          }\n        }\n      }\n    "], ["\n      id\n      name\n      email\n      cart {\n        id\n        quantity\n        product {\n          name\n          price\n          description\n          id\n          photo {\n            id\n            image {\n              id\n              publicUrlTransformed\n            }\n          }\n        }\n      }\n    "])))
                        })];
                case 1:
                    user = _b.sent();
                    ...
                    console.log(amount);
                    return [4 /*yield*/, stripe_1["default"].paymentIntents
                            .create({
                            amount: amount,
                            currency: "USD",
                            confirm: true,
                ...
                case 2:
                    ...
                    return [4 /*yield*/, context.lists.Order.createOne({
                            data: {
                                total: charge.amount,
                                charge: charge.id,
